          ...
          <div className="work-experience">
            ...
            <ul className="experience-list">
              ...
              <li className="experience-item">
                ...
                <ul style={{ listStyleType: "disc", paddingLeft: "20px" }}>
                  <li>
                    Worked as a full-stack web developer on Node.js, MongoDB,
                    and React.js.
                  </li>
                  <li>
                    Developed secure authentication CRUD APIs and integrated
              ...
              <li className="project-item">
                ...
                <p className="description">
                  <ul style={{ listStyleType: "disc", paddingLeft: "20px" }}>
                    ...
                    <li>Simplifies organization and enhances productivity.</li>
                  </ul>
                </p>
                <a
                  href="https://github.com/your-repo/MemoMate.git"
